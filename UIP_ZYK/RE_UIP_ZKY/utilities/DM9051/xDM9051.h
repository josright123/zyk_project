...
//uint8_t _DM9051_Read_Reg(uint8_t Reg_Off);
//void _DM9051_Write_Reg(uint8_t Reg_Off, uint8_t spi_data);
//void _DM9051_Read_Mem(uint8_t *pu8data, uint32_t datalen);
//void _DM9051_Write_Mem(uint8_t *pu8data, uint32_t datalen);
