...
#define GENERATED_ATTRIBUTE_COUNT 229
...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0x04), 0x00000002, 1, ZAP_TYPE(BITMAP8), 0 }, /* OccupancySensorTypeBitmap */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */  \
...
\
  ...
  { ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* ClusterRevision */  \
\
  /* Endpoint: 3, Cluster: Boolean State (server) */ \
...
#define FIXED_DEVICE_TYPES {{0x00000016,1},{0x00000107,1},{0x00000302,1},{0x00000015,1}}
