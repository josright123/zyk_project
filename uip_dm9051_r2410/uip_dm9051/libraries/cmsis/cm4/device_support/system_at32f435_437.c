...
unsigned int system_core_clock_in;
...
system_core_clock_in = system_core_clock;
  /* get sclk source */
...
//printf("sclk_source, CRM_SCLK_HICK: %u calc-to %u (HICK_VALUE * 6)\r\n", system_core_clock_in, system_core_clock);
sprintf(pntdat[pntdatc].pntbff, "sclk_source, CRM_SCLK_HICK: %u calc-to %u (HICK_VALUE * 6)\r\n", system_core_clock_in, system_core_clock);
pntdatc++;
pntdat[pntdatc-1].n = pntdatc;
      } else {
        system_core_clock = HICK_VALUE;
//printf("sclk_source, CRM_SCLK_HICK: %u calc-to %u (HICK_VALUE * 1)\r\n", system_core_clock_in, system_core_clock);
sprintf(pntdat[pntdatc].pntbff, "sclk_source, CRM_SCLK_HICK: %u calc-to %u (HICK_VALUE * 1)\r\n", system_core_clock_in, system_core_clock);
pntdatc++;
pntdat[pntdatc-1].n = pntdatc;
	  }
      break;
...
//printf("sclk_source, CRM_SCLK_HEXT: %u calc-to %u (HEXT_VALUE)\r\n", system_core_clock_in, system_core_clock);
sprintf(pntdat[pntdatc].pntbff, "sclk_source, CRM_SCLK_HEXT: %u calc-to %u (HEXT_VALUE)\r\n", system_core_clock_in, system_core_clock);
pntdatc++;
pntdat[pntdatc-1].n = pntdatc;
      break;
    case CRM_SCLK_PLL:
...
//.1000000000 / 4 = 250 MHz
sprintf(pntdat[pntdatc].pntbff, "(((uint64_t)pllrcsfreq * pll_ns) / (pll_ms * pll_fr), %u %u %u %u\r\n", 
		pllrcsfreq, pll_ns, pll_ms, pll_fr);
pntdatc++;
pntdat[pntdatc-1].n = pntdatc;
      system_core_clock = (pllrcsfreq * pll_ns) / (pll_ms * pll_fr);
//printf("sclk_source, CRM_SCLK_PLL: %u calc-to %u (pll_fr)\r\n", system_core_clock_in, system_core_clock);
sprintf(pntdat[pntdatc].pntbff, "sclk_source, CRM_SCLK_PLL: %u calc-to %u (pll_fr)\r\n", system_core_clock_in, system_core_clock);
pntdatc++;
pntdat[pntdatc-1].n = pntdatc;
      break;
    default:
      system_core_clock = HICK_VALUE;
//printf("sclk_source, default: %u calc-to %u (HICK_VALUE)\r\n", system_core_clock_in, system_core_clock);
sprintf(pntdat[pntdatc].pntbff, "sclk_source, default: %u calc-to %u (HICK_VALUE)\r\n", system_core_clock_in, system_core_clock);
pntdatc++;
pntdat[pntdatc-1].n = pntdatc;
      break;
  }
...
//printf("sclk_source, [FINAL]: %u calc-to %u (>> div_value), div_value= %d\r\n", system_core_clock_in, system_core_clock, div_value);
sprintf(pntdat[pntdatc].pntbff, "sclk_source, [FINAL]: %u calc-to %u (>> div_value), div_value= %d\r\n", system_core_clock_in, system_core_clock, div_value);
pntdatc++;
pntdat[pntdatc-1].n = pntdatc;
}
/**
