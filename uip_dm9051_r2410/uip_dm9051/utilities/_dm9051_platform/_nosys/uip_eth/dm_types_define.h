...
#define identify_tcpip_ip(ip4adr) SET_FIELD1(final_ip, ip4adr, candidate_eth_ip())
#define identify_tcpip_gw(ip4adr) SET_FIELD1(final_gw, ip4adr, candidate_eth_gw())
